## Здраствуйте это сообщение от участника 
Я не трогал сильно эту папку, все про мое задание как ни странно находится в папке задание. 
Так же как запустить проект и проверить есть в папке задание в файле README.md (задание/README.md)
Для проверки необходим докер. Так же желательно postmen, но при желании можно через curl.
